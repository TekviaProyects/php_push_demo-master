...
const applicationServerPublicKey = 'BPEp_jqXPIyLXy-C3B3yhgbS83VtuJMmwvjDNhYauqj30PWBNZ4dX_qumvMCECWDI58xmvC-8oXK7GEmZ5cUyoM';
...
sendPushButton.addEventListener('click', () =>
  ...
  .then(subscription => {
      ...
      var algo = fetch('send_push_notification.php', {
          method: 'POST',
          body: JSON.stringify({
              endpoint: subscription.endpoint,
              key: key ? btoa(String.fromCharCode.apply(null, new Uint8Array(subscription.getKey('p256dh')))) : null,
      ...
      console.log("===========A aLAGOAOGOAOO ", algo);
  })
);